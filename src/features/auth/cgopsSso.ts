// CGOPS SSO handoff — receiving side.
//
// CGOPS launches New Restaurant Center in a new tab with session tokens in
// the URL fragment:
//
//   https://<new-restaurant-center>/#cgops_sso=1&access_token=...&refresh_token=...
//
