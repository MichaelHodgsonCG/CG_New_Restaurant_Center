// New Restaurant Center has no standalone login — CGOPS is the front door.
// Anyone arriving without a session (or after signing out) is sent to CGOPS,
// which relaunches this app with the SSO handoff fragment (cgopsSso.ts).
    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 px-4">
      ...
      {cgopsUrl ? (
        ...
        <p className="max-w-sm text-center text-sm text-danger">
          ...
          New Restaurant Center sign-in happens through CGOPS.
        </p>
      )}
    </div>
  )
