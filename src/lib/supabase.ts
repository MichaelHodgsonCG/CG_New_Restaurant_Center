...
// the browser; server-side work belongs in edge functions. This app runs
// against the shared CGOPS Platform Supabase project (same project as People
// Center), so it never creates or points at a new Supabase project.
...
// session alive forever. (Same convention as CGOPS / People Center — CGOPS is
