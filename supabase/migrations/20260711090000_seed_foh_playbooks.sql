-- ============================================================================
-- Migration: seed_foh_playbooks  (ASCII-safe)
-- Populate opening playbooks + task templates from the operational Excel
-- checklists + BT Richmond Hill opening training schedule.
-- Apply to the CGOPS Platform Supabase project.
-- Reusable relative offsets (negative = before anchor, positive = after).
-- Sub-items folded into description. Adds opening_task_templates.category.
-- Idempotent: replaces templates for these six playbooks on re-run.
-- Task text normalized to plain ASCII (and, at, percent) for SQL-editor safety.
-- ============================================================================
...
from public.opening_playbooks p, (values
  ...
  ('Meet with and confirm any potential TM Transfers', null, 'Hiring', 'opening_date', -28, 'General Manager', 1),
  ...
  ('During interviews, complete shared staffing doc to collect TM info, organize hires and make as many notes as possible', null, 'Hiring', 'opening_date', -28, 'General Manager', 4),
  ...
  ('Collect and prepare TM information for TM Emailers and share with Megan (e-mail)', null, 'Hiring', 'opening_date', -28, 'General Manager', 11),
  ('Collect and prepare TM information for Push invites and share with SM (name, email, role, wage if above min)', null, 'Hiring', 'opening_date', -28, 'General Manager', 12),
  ('Follow up to verify ALL TM information is entered into Push', null, 'Hiring', 'opening_date', -28, 'General Manager', 13),
  ('Send Q and A e-mail with FAQ (see template)', null, 'Hiring', 'opening_date', -28, 'General Manager', 14),
  ...
  ('Follow up and assist BM, SM and GSM regarding their restaurant set up checklists', null, 'Restaurant Set Up', 'handover_date', 2, 'General Manager', 23),
  ('Order paper: harvey at directlinesupplies.com', null, 'Restaurant Set Up', 'handover_date', 2, 'General Manager', 24),
  ('Set up bookmarks on Google Chrome for all team sessions', null, 'Restaurant Set Up', 'handover_date', 2, 'General Manager', 25),
  ('JHSC board set up, see Axonify for required documents (green book given by HQ) (certified TMs determined at job fair)', null, 'Restaurant Set Up', 'handover_date', 2, 'General Manager', 26),
  ...
  ('Prepare self and managers for training and seminars', null, 'Training', 'opening_date', -12, 'General Manager', 32),
  ...
  ('Review Axonify completion for all FOH and BOH', null, 'Training', 'opening_date', -12, 'General Manager', 34),
  ...
  ('Work with Ops team to prepare for dry runs (server and manager section plotting, menus, tip out, reads, duties)', null, 'Dry Runs', 'opening_date', -3, 'General Manager', 38),
  ...
  ('Hold Pre and Post-Shift mtgs with all TMs and Ops for each Dry Run service period - notes prepared in advance', null, 'Dry Runs', 'opening_date', -3, 'General Manager', 41),
  ('Oversee dry run service of the host and serving teams', null, 'Dry Runs', 'opening_date', -3, 'General Manager', 42),
  ('Closely watch TMs and Managers in their roles to coach and follow up concerns as needed', null, 'Dry Runs', 'opening_date', -3, 'General Manager', 43),
  ...
  ('All uniforms are organized and stored, prepared for 1st uniform inventory', null, 'Uniforms', 'opening_date', -10, 'General Manager', 46),
  ...
  ('Management Keys, hand out and maintain list of current key holders', null, 'Security', 'opening_date', 0, 'General Manager', 51),
  ...
  ('Set up account for window cleaners on monthly basis', null, 'Repairs and Maintenance', 'opening_date', 0, 'General Manager', 53),
  ('Print trade list provided by Director of Construction for all warranty repairs', null, 'Repairs and Maintenance', 'opening_date', 0, 'General Manager', 54),
  ('Research Night Cleaning companies, and submit costs to ROL', null, 'Repairs and Maintenance', 'opening_date', 0, 'General Manager', 55),
  ('All areas of restaurant, clean and in excellent condition pre-open', null, 'Repairs and Maintenance', 'opening_date', 0, 'General Manager', 56),
  ('All Managers attend POS training with Silverware', null, 'Silverware', 'handover_date', 3, 'General Manager', 57),
  ('Go through all menu items to ensure they are 100 percent correct to Silverware', null, 'Silverware', 'handover_date', 3, 'General Manager', 58),
  ...
  ('Set overbooking code and only share w/ Mgmt', null, 'Open Table', 'opening_date', 0, 'General Manager', 64),
  ...
  ('Acquire extra shelving and hooks where needed (consult DOC before any purchases)', null, 'Office', 'opening_date', 0, 'General Manager', 69),
  ...
  ('Tills + Petty Cash set and labelled', null, 'Accounting', 'opening_date', 0, 'General Manager', 73),
  ...
  ('Coaches '' best look'' and full tools', null, 'Uniforms in Action', 'opening_date', -10, 'General Manager', 77),
  ...
  ('Review support feedback cards - address notes, needs and performance concerns quickly', null, 'Support Team', 'opening_date', 0, 'General Manager', 80),
...
from public.opening_playbooks p, (values
  ...
  ('Bar binder with recipes and specs assembled', null, 'Checklists and Documents for Bartender Portfolios', 'handover_date', 2, 'Beverage Manager', 5),
  ('Service incident report binder assembled, current ID verification booklet obtained', null, 'Checklists and Documents for Bartender Portfolios', 'handover_date', 2, 'Beverage Manager', 6),
  ('Complete audit of duties and checklists to ensure they are specific for your location', '- Bartender: Opening and Closing duties  - Train The Trainer (TTT) document created for all cocktails/ mocktails/ pouring techniques  - Bartender accountabilities template established for training  - FOTW bartender document assembled  - Stocking lists/pars', 'Checklists and Documents for Bartender Portfolios', 'handover_date', 2, 'Beverage Manager', 7),
  ('Determine all local channels and post at AV cabinet', null, 'Checklists and Documents for Bartender Portfolios', 'handover_date', 2, 'Beverage Manager', 8),
  ('All invoices are entered into OC - Have you entered every type of invoice at this point TBS LCBO', null, 'Beverage Inventory and Invoices', 'opening_date', -3, 'Beverage Manager', 9),
  ('Organize all orders when receiving and use photos from other restaurants to duplicate organization', null, 'Beverage Inventory and Invoices', 'opening_date', -3, 'Beverage Manager', 10),
  ('First inventory is completed day before opening to public', null, 'Beverage Inventory and Invoices', 'opening_date', -3, 'Beverage Manager', 11),
  ('Review manual calculation of COGs (opening + purchase - closing / sales)', null, 'Beverage Inventory and Invoices', 'opening_date', -3, 'Beverage Manager', 12),
  ('Review Group Totals, idenifty ideal vs actual and on hand inventory ( )', null, 'Beverage Inventory and Invoices', 'opening_date', -3, 'Beverage Manager', 13),
  ('Inventory accuracy importance before open', null, 'Beverage Inventory and Invoices', 'opening_date', -3, 'Beverage Manager', 14),
  ('Beverage Playbook is accesible via Axonify', null, 'Beverage Playbook and Specs', 'opening_date', -10, 'Beverage Manager', 15),
  ('All Bev Specs and standards are reviewed and tests passed to 100 percent', null, 'Beverage Playbook and Specs', 'opening_date', -10, 'Beverage Manager', 16),
  ('Untapped downloaded and store account accesible', null, 'Beverage Playbook and Specs', 'opening_date', -10, 'Beverage Manager', 17),
  ('Organize OC inventory pages Costumize Sort vs. Countsheet Setup vs. Manage Locations', null, 'Storage and Organization', 'handover_date', 2, 'Beverage Manager', 18),
  ('Set up bar and storage areas to the highest standard including labelling/maps:', '- Includes all shelving, bar fridges, coolers, keg fridge and storage areas  - Spirits in back bar/ storage areas organized via category  - Beer Wall (display and behind bar) stocked alphbetaically  - Bar top and Bar expo areas.  - POD organization: Empties Return, rotational vs. static glassware, coasters, bar smallwares  - Identify ''key hires'' to assist with this  - Cocktail Cheat Sheet and Garnish chart laminated and posted by service  - Keg Fridge Cleanliness Checklist laminated and posted  - Beer Clean Glassware Laminated and posted  - How to use a Coupler laminated and posted  - Types of Couplers Laminted and posted  - Draught Beer list laminted and posted in draught beer fridge  - Proper Keg Fridge Storage laminated and posted  - Chalkboards filled out neatly behind bar and around restaurants  - Photos should be taken and shared of any area/bar top to train and re-inforce standards', 'Storage and Organization', 'handover_date', 2, 'Beverage Manager', 19),
  ('Assist in execution of beverage seminars', null, 'Beverage and Bartender Training', 'opening_date', -12, 'Beverage Manager', 20),
  ('Assist TM''s during training with coaching, learning, questions and testing. Highlight those who may stand out', null, 'Beverage and Bartender Training', 'opening_date', -12, 'Beverage Manager', 21),
  ('Activate utilization of TTT document for bartenders, managers, and supervisors in training', null, 'Beverage and Bartender Training', 'opening_date', -12, 'Beverage Manager', 22),
  ('Assess ongoing Axonify completion for bartenders and supervisors', null, 'Beverage and Bartender Training', 'opening_date', -12, 'Beverage Manager', 23),
  ('Organize Bar Information board with rotational pours and important information', null, 'Beverage and Bartender Training', 'opening_date', -12, 'Beverage Manager', 24),
  ('Initial orders for all Beer Suppliers, LCBO and Beer Store to hold onto until liquor license is official', null, 'Ordering', 'opening_date', -5, 'Beverage Manager', 25),
  ('Plan triple and quadruple deck for rotational pours (minumum 60L per line)', null, 'Ordering', 'opening_date', -5, 'Beverage Manager', 26),
  ('Rotational planning completed after on deck supplied by Ops', null, 'Ordering', 'opening_date', -5, 'Beverage Manager', 27),
  ('Do you have 0 percent drink stickers', null, 'Ordering', 'opening_date', -5, 'Beverage Manager', 28),
  ('All VIP and Dry Run needs ordered: minerals, juices, bar condiments, garnishes (Fresh Start and Sysco)', null, 'Ordering', 'opening_date', -5, 'Beverage Manager', 29),
  ...
  ('Set-up and organize all equipment - for use /storage', null, 'Bar Smallwares/Tools', 'opening_date', 0, 'Beverage Manager', 31),
  ('Stamp all 6 pack carriers and Growler tags', null, 'Bar Smallwares/Tools', 'opening_date', 0, 'Beverage Manager', 32),
  ...
  ('Easily navigated (i.e. Alphabetical Order and Rotational Line )', null, 'Schedules', 'opening_date', 0, 'Beverage Manager', 42),
  ('You are responsible for managing the ''Glassware'' ''line'' on the P and L', null, 'Schedules', 'opening_date', 0, 'Beverage Manager', 43),
  ...
  ('We have appropriate levels of stock of both Glassware and Coasters for all beers', null, 'Schedules', 'opening_date', 0, 'Beverage Manager', 46),
  ('Weekly glassware and inventory sheets/ par levels are set up', null, 'Schedules', 'opening_date', 0, 'Beverage Manager', 47),
  ('You are aware of your budget', null, 'Schedules', 'opening_date', 0, 'Beverage Manager', 48),
  ('You will be 100 percent stocked, 100 percent of the time.', null, 'Schedules', 'opening_date', 0, 'Beverage Manager', 49),
  ('Order guides are printed and laminated for all bev purchasing (wine, LCBO, TBS, static bottles and cans)', null, 'Order Templates/ Guides', 'opening_date', -5, 'Beverage Manager', 50),
  ...
  ('Teach and uphold standards and coaches ''best look''', null, 'Uniforms', 'opening_date', -10, 'Beverage Manager', 57),
...
from public.opening_playbooks p, (values
  ...
  ('Compile Server and Bartender info for Silverware database list. Ensure accuracy. Send to Chelsey.', null, 'TMs in Silverware', 'handover_date', 3, 'Service Manager', 10),
  ...
  ('Identify key TMs to help stock and set up dining room', '- Salt, pepper, vinegar, oil all filled  - Cutlery polished and rolled  - Side plates polished  - Butcher paper cut, side plates/fry cups/burger trays lined  - Sticker bill clipboards and stuff bill clipboards (postcard, comment card)  - Rubber feet on cubes', 'Restaurant Set Up', 'handover_date', 2, 'Service Manager', 12),
  ...
  ('Complete audit of duties and checklists to ensure they are specific for your location', '- Server: Opening and Closing duties  - Server: Running Duties  - Server: Cleaning Schedule: Daily/Weekly/Monthly', 'Checklists and Documents for Server Portfolios', 'handover_date', 2, 'Service Manager', 25),
  ('Set up FOTW chart with names for all FOH', null, 'Checklists and Documents for Server Portfolios', 'handover_date', 2, 'Service Manager', 26),
  ('Prepare FOTW for first 8 weeks (print standards, fill out charts) - have posted for orientation', null, 'Checklists and Documents for Server Portfolios', 'handover_date', 2, 'Service Manager', 27),
  ('Pre-shift notes completed for 4 weeks and on clipboard, include beverage tasting and notes', null, 'Checklists and Documents for Server Portfolios', 'handover_date', 2, 'Service Manager', 28),
  ...
  ('Create Server schedules following GM notes and par levels', null, 'Schedules', 'opening_date', 0, 'Service Manager', 32),
...
from public.opening_playbooks p, (values
  ...
  ('Complete audit of duties and checklists to ensure they are specific for your location', '- Host: Opening and Closing duties  - Host: Running Duties  - Host: Cleaning Schedule: Daily/Weekly/Monthly', 'Checklists and Documents for Host Portfolios', 'handover_date', 2, 'Guest Service Manager', 14),
  ...
  ('Assemble MSDS binder, include sheets for all chemicals in house (inventory chemicals and print sheets from Diversey online)', null, 'Miscellaneous Set Up', 'handover_date', 2, 'Guest Service Manager', 17),
  ('All TMs added to Open Table for section assignment and reservation tracking', null, 'Open Table and Silverware', 'handover_date', 3, 'Guest Service Manager', 18),
  ('Host in Silverware for Take Out (4000) - test', null, 'Open Table and Silverware', 'handover_date', 3, 'Guest Service Manager', 19),
  ('Host in Silverware for open counts (3000) - test', null, 'Open Table and Silverware', 'handover_date', 3, 'Guest Service Manager', 20),
  ('Designated ''Full'' Clover labelled and present at Host desk', null, 'Open Table and Silverware', 'handover_date', 3, 'Guest Service Manager', 21),
  ...
  ('Create host schedules following GM notes and par levels', null, 'Schedules', 'opening_date', 0, 'Guest Service Manager', 25),
...
select p.id, v.title, v.description, v.category, v.anchor_type, v.offset_days, v.owner, false, v.seq, true
from public.opening_playbooks p, (values
  ('Arrange pre-open bootcamp and review agenda', null, 'Pre-Training', 'opening_date', -35, 'Regional Operations Leader', 0),
  ('Management team selection, offers, overseeing and following up on their training', null, 'Pre-Training', 'opening_date', -35, 'Regional Operations Leader', 1),
  ('Review projected staffing levels and make recommendations necessary', null, 'Pre-Training', 'opening_date', -35, 'Regional Operations Leader', 2),
  ...
  ('Participation in TM hiring, onboarding and training', null, 'Pre-Training', 'opening_date', -35, 'Regional Operations Leader', 6),
  ...
  ('Review TM training outline with Megan and Shanna - make tweaks/advancements as needed since last open', null, 'Pre-Training', 'opening_date', -35, 'Regional Operations Leader', 9),
  ...
  ('Prepare special day for Dry Runs and VIP Party in Open Table', null, 'Pre-Training', 'opening_date', -35, 'Regional Operations Leader', 12),
  ...
  ('Set floor management expectations for open - 100 percent table checks, mgmt sections 45 second greet, complaint handling', null, 'Pre-Training', 'opening_date', -35, 'Regional Operations Leader', 15),
  ...
  ('Participate in orientation and running seminars as assigned in training plan', null, 'During Training', 'opening_date', -12, 'Regional Operations Leader', 20),
  ('Review TM schedule for first few weeks (first 10 days no splits, no overs, no ''thrus''. FOH 10am and 4pm starts)', null, 'During Training', 'opening_date', -12, 'Regional Operations Leader', 21),
  ...
  ('IGDC and sleeves', null, 'Product', 'opening_date', 0, 'Regional Operations Leader', 44),
  ('Silverware cards', null, 'Product', 'opening_date', 0, 'Regional Operations Leader', 45),
  ('Front door names and hours of ops', null, 'Product', 'opening_date', 0, 'Regional Operations Leader', 46),
  ...
  ('Review bottle drop plan with GM and GSM', null, 'Marketing/VIP Party', 'opening_date', -2, 'Regional Operations Leader', 53),
  ...
  ('Push and Push Tablet', null, 'IT Items Functional', 'opening_date', 0, 'Regional Operations Leader', 59),
  ...
  ('A/V Equipment and Security', null, 'Management Orientation', 'opening_date', 0, 'Regional Operations Leader', 67),
  ...
  ('Reservation system and printer, phones', null, 'Management Orientation', 'opening_date', 0, 'Regional Operations Leader', 71),
  ('POS and Clover', null, 'Management Orientation', 'opening_date', 0, 'Regional Operations Leader', 72),
  ...
  ('Review support feedback cards - address notes, needs and performance concerns quickly', null, 'Support Period', 'opening_date', 0, 'Regional Operations Leader', 76),
  ...
  ('All postings on front door (hours of ops, GM and Chef names)', null, 'Support Period', 'opening_date', 0, 'Regional Operations Leader', 79),
